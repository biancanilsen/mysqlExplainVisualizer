// src/components/columns/InputColumn.tsx
          ...
          <div className="flex-1 flex flex-col gap-3 min-h-0">
            ...
            <div className="flex-shrink-0">
              <div className="flex items-center gap-2">
                <Button color="primary" onPress={analyze} size="lg">Analisar</Button>
                <span className="text-xs text-gray-500">Clique em um nó para ver detalhes.</span>
              </div>
            </div>
          </div>
